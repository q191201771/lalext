...
MKINSTALLDIRS   := /Volumes/T7/new/a_chef_git/lalext/thirdparty/freetype-2.13.0/builds/unix/./install-sh -c -d
...
LIBSSTATIC_CONFIG          := -lfreetype -lz -lbz2 -L/opt/homebrew/Cellar/libpng/1.6.39/lib -lpng16 -lz -L/opt/homebrew/Cellar/harfbuzz/7.3.0/lib -L/opt/homebrew/opt/freetype/lib -L/opt/homebrew/Cellar/libpng/1.6.39/lib -L/opt/homebrew/Cellar/glib/2.76.3/lib -L/opt/homebrew/opt/gettext/lib -L/opt/homebrew/Cellar/pcre2/10.42/lib -L/opt/homebrew/Cellar/graphite2/1.3.14/lib -lharfbuzz -lm -framework ApplicationServices -lfreetype -lbz2 -lpng16 -lz -lglib-2.0 -lintl -liconv -lm -framework Foundation -framework CoreFoundation -framework AppKit -framework Carbon -lpcre2-8 -D_THREAD_SAFE -pthread -lgraphite2 -L/opt/homebrew/Cellar/brotli/1.0.9/lib -R/opt/homebrew/Cellar/brotli/1.0.9/lib -lbrotlidec -R/opt/homebrew/Cellar/brotli/1.0.9/lib -lbrotlicommon
build_libtool_libs         := 
ft_version                 := 25.0.19
